...
$(function() {
  $(window).scroll(function() {
    ...
    if (re_width > 1024) {
      ...
      var class_height =
        $(".js_header").height() + $(".js_side_right").height();
      scrollValue > class_height
        ? $(".js_class_menu").addClass("fixed_top")
        : $(".js_class_menu").removeClass("fixed_top");
    }
    // if(scrollValue > 70){
...
$(".js_nav_menu li").on({
  mouseover: function() {
    $(this)
      .find("span")
      .show()
      .animate({ top: "50px", "font-size": "12px" }, 500);
  },
  mouseleave: function() {
    $(this)
      .find("span")
      .hide()
      .animate({ top: "40px", "font-size": "10px" }, 10);
  }
});
//底部显示二维码------------------------------------------------------------------------
$(".js_ewm_small").on({
...
$(".js_about_ul li").on("click", function() {
  ...
  $(this)
    .parents(".js_about_side_main")
    .find(".js_detail_content")
    .eq(index_li)
    .show()
    .siblings(".js_detail_content")
    .hide();
});
$(".js_about_money li").on({
  mouseover: function() {
    ...
    var index_li = $(this).index();
    $(this)
      .parents(".js_about_money")
      .next(".js_about_money_r")
      .find(".ewm")
      .eq(index_li)
      .show()
      .siblings(".ewm")
...
//       var last_height =
//         box.last().get(0).offsetTop + Math.floor(box.last().height() / 2);
